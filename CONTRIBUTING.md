# Contribute to `scaleway-secrets-store-csi`
...
- Open a pull request against `scaleway-secrets-store-csi` main branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `scaleway-secrets-store-csi` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
